...
{
    public class SuperAdvancedChatController : Controller
    {
        private readonly ILogger<AdvancedChatController> _logger;
        private readonly ApplicationDbContext _context;
        private readonly IHubContext<AdvancedChatHub> _hub;

        public SuperAdvancedChatController(ILogger<AdvancedChatController> logger, ApplicationDbContext context, IHubContext<AdvancedChatHub> hub)
        {
            _logger = logger;
            _context = context;
            _hub = hub;
